  ...
  <div class="cart">
      ...
      <div class="cart-body">
        ...
        <ul class="cart-list" v-for="(cart) in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked='cart.isChecked==1' @click='upDataChecked(cart,$event)'/>
          </li>
    ...
    <div class="cart-tool">
      <div class="select-all">
        <input class="chooseAll" type="checkbox" :checked='isAllCheck==1&&cartInfoList.length>0' @change="updateAllCartChecked"/>
        <span>全选</span>
      </div>
      <div class="option">
...
export default {
  ...
  methods: {
    ...
    async deleteCart(cartId){
      try {
        await this.$store.dispatch('deleteCartListBySkuId',cartId);
        this.getData()
      } catch (error) {
        alert(error.message)
      }
