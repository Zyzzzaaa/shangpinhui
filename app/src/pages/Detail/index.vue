        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  ...
                  v-for="skuSaleAttrValue in skuSaleAttr.spuSaleAttrValueList"
                  :key="skuSaleAttrValue.id"
                  @click="changeActive(skuSaleAttrValue,skuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 在进行路由跳转之前，发请求把产品信息通过请求的形式通知服务器，服务器进行响应的存储 -->
